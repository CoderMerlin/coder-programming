...
# :mega: 本章主要介绍JAVA基础知识中的——线程相关知识面试题！ #

### 线程类知识点 ### 

- [1.进程与线程之间有什么区别？](ProcessAndThread.md)
- [2.进程、线程都各有什么特点？](ProcessAndThread.md)
- [3.进程之间的是怎么进行交互的呢？](ProcessAndThread.md)
- [4.什么是缓冲区溢出？](ProcessAndThread.md)
- [5.进程之间如何进行交互？](ProcessAndThread.md)
- [6.线程之间如何进行交互？](ProcessAndThread.md)
